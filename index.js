function loco() {
  ...
  ScrollTrigger.scrollerProxy("#main", {
    ...
    // LocomotiveScroll handles things completely differently on  devices - it doesn't even transform the container at all! So to get the correct behavior and avoid jitters, we should pin things with position: fixed on . We sense it by checking to see if there's a transform applied to the container (the LocomotiveScroll-controlled element).
